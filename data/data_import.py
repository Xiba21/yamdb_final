...
if __name__ == '__main__':
    upload_data = {
        ...
        'category.csv':
        'INSERT INTO api_category(id, name, slug) VALUES (?,?,?)',
        'titles.csv':
        'INSERT INTO api_title (id, name, year, category_id) VALUES (?,?,?,?)',
        'review.csv':
        'INSERT INTO api_review (id, title_id, text, author_id, \
            score, pub_date) VALUES (?,?,?,?,?,?)',
        'comments.csv':
        'INSERT INTO api_comment (id, review_id, text, author_id, pub_date) \
            VALUES (?,?,?,?,?)',
        'genre_title.csv':
        'INSERT INTO api_title_genre (id, title_id, genre_id) VALUES (?,?,?)',
    }
